...
func local_1442(v0, v1) -> Variant:
	...
	while true:
		if _pc == 1442:
			...
			if global.pog_int("g_parking_slots") < v3:
				_pc = 1485
				continue
			else:
				_pc = 1663
...
func local_3398(v0, v1, v2, v3) -> Variant:
	...
	while true:
		if _pc == 3398:
			...
			await _pog_wait(1.0)
			if 1 != global.exists("g_spewer_in_use"):
				_pc = 3599
				continue
			else:
				_pc = 3438
...
func freelance_mine(v0) -> Variant:
	...
	while true:
		if _pc == 30741:
			...
			if not (await iutilities.player_in_range_of_group(v0)) or not _pog_eq(v0, sim.group(v8)):
				_pc = 32195
				continue
			else:
				_pc = 32200
...
func police_raid(v0) -> Variant:
	...
	while true:
		if _pc == 54007:
			...
			if 14 == ihabitat.allegiance(ihabitat.cast(list.get_nth(v3, v8))):
				_pc = 54467
				continue
			else:
				_pc = 54485
