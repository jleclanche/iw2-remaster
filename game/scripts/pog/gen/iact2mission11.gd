...
func local_424(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17) -> Variant:
	...
	while true:
		if _pc == 424:
			...
			await _pog_frame()
			if _pog_every(430, 0.10000000149011612):
				_pc = 443
				continue
			else:
				_pc = 983
...
func local_6222(v0, v1, v2, v3) -> Variant:
	...
	while true:
		if _pc == 6222:
			...
			if await iutilities.player_in_range(v8) and v5:
				_pc = 6921
				continue
			else:
				_pc = 6972
...
func local_6980(v0, v1) -> Variant:
	...
	while true:
		if _pc == 6980:
			...
			if _pog_is_null(group.sim_count(v18)) and v25 and state.progress(v0) >= 2:
				_pc = 9481
				continue
			else:
				_pc = 9486
...
func local_9501(v0, v1, v2, v3, v4, v5, v6, v7) -> Variant:
	...
	while true:
		if _pc == 9501:
			...
			await _pog_wait(0.5)
			if sim.distance_between(v1, group.leader(v9)) >= 30000.0:
				_pc = 10717
				continue
			else:
				_pc = 10638
...
func local_12880(v0, v1) -> Variant:
	...
	while true:
		if _pc == 12880:
			...
			v7 = iship.cast(group.nth_sim(v0, v6))
			iai.purge_orders(v7)
			iai.give_attack_order(v7, v5)
			isim.capsule_jump_custom(v7, v1, math.random(-1.0, 1.0), math.random(-1.0, 1.0), v2)
			_pc = 13346
			continue
		elif _pc == 13346:
			await _pog_wait(0.10000000149011612)
			if not (isim.is_capsule_jumping(v7)):
				_pc = 13401
				continue
			else:
				_pc = 13346
			...
			iship.set_free_without_pilot(v7, v4)
			iai.give_attack_order(v7, v5)
			await _pog_wait(v3)
			v6 = v6 + 1
			_pc = 13157
