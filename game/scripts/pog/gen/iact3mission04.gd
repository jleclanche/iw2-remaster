...
func local_10479(v0, v1, v2, v3, v4, v5, v6) -> Variant:
	...
	while true:
		await _pog_wait(0.10000000149011612)
		if not (300.0 > sim.distance_between_centres(v0, v6)):
			break
...
func local_15369(v0, v1, v2) -> Variant:
	...
	while true:
		await _pog_wait(0.10000000149011612)
		if not (100.0 > sim.distance_between_centres(v2, v0)):
			break
